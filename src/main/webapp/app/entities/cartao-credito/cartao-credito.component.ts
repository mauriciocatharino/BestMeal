...
export class CartaoCreditoComponent implements OnInit, OnDestroy {
  ...
  registerChangeInCartaoCreditos() {
    this.eventSubscriber = this.eventManager.subscribe('cartaoCreditoListModification', response => this.reset());
  }
  ...
  protected paginateCartaoCreditos(data: ICartaoCredito[], headers: HttpHeaders) {
    ...
    for (let i = 0; i < data.length; i++) {
      this.cartaoCreditos.push(data[i]);
    }
  }
