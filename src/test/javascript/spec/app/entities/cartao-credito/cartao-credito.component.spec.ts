...
import { CartaoCreditoComponent } from 'app/entities/cartao-credito/cartao-credito.component';
...
describe('Component Tests', () => {
  describe('CartaoCredito Management Component', () => {
    let comp: CartaoCreditoComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CartaoCreditoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.cartaoCreditos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
